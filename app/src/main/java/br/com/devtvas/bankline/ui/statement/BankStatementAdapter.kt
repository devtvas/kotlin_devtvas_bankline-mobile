...
import br.com.devtvas.bankline.databinding.BankStatementItemBinding
 ...
 *
 * lembrando que essa classe faz o link entra as camadas:
 * Telas + Entidades
 * ou
 * Views + Models
 *
...
class BankStatementAdapter(private val dataSet: List<Movimentacao>) : RecyclerView.Adapter<BankStatementAdapter.ViewHolder>() {
    ...
    class ViewHolder(private val binding: BankStatementItemBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(item: Movimentacao) = with(binding) {
            ...
            val typeIcon = if (TipoMovimentacao.RECEITA == item.movimentacaoTipo) R.drawable.ic_money_in else R.drawable.ic_money_out
